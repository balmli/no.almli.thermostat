    ...
    it('maps thermostat control settings for same and direct-child zones', () => {
        expect(
            DeviceSettingsMapper.map(DRIVER_VTHERMO, {
                ...
                devices_zone_coolers: true,
                devices_zone_sockets_heaters: false,
                devices_zone_sockets_coolers: true,
                devices_zone_thermostats: false,
                devices_sub_zones_heaters: false,
                devices_sub_zones_coolers: true,
                devices_sub_zones_sockets_heaters: true,
                devices_sub_zones_sockets_coolers: false,
                devices_sub_zones_thermostats: true,
                contact_alarm: true,
                contact_alarm_delay: 30,
                motion_alarm: false,
                hysteresis: 0.25,
                invert: true,
                onoff_enabled: true,
                ...
                min_on_duration: 60,
                preset_eco_offset: -2.5,
                preset_away_temp: 10.0,
                preset_boost_offset: 3.0,
                failsafe_enabled: true,
                frost_alarm_temp: 6.0,
                overheat_alarm_temp: 38.0,
                condensation_protection: true,
            }),
        ).toEqual({
            zone: {clazz: true, coolers: true, sockets_heaters: false, sockets_coolers: true, thermostats: false},
            sub_zones: {clazz: false, coolers: true, sockets_heaters: true, sockets_coolers: false, thermostats: true},
            contactAlarm: true,
            ...
            presetEcoOffset: -2.5,
            presetAwayTemp: 10.0,
            presetBoostOffset: 3.0,
            failsafeEnabled: true,
            frostAlarmTemp: 6.0,
            overheatAlarmTemp: 38.0,
