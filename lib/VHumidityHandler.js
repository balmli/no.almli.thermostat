...
module.exports = class VHumidityHandler extends BaseHandler {
    ...
    _calcHumidity(humidities, humSettings) {
        ...
        if (humidities.length > 0) {
            ...
            } else if (humSettings.calcMethod === constants.CALC_METHODS.NEWEST) {
    ...
    async switchDevice(device) {
        ...
        const onoff = this._resolveOnOff(settings, node, targetHumidity, humidity);
    ...
    _resolveOnOff(settings, node, targetHumidity, humidity) {
